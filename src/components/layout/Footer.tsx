      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-12 mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-12">
            ...
            {/* Dare to Dream Award Card */}
            <div className="flex flex-col justify-start">
              <h4 className="mono text-[9px] font-bold tracking-widest text-white/30 uppercase mb-4">Recognition</h4>
              <div className="relative bg-gradient-to-br from-[var(--saffron)]/15 to-[var(--green)]/10 border border-[var(--saffron)]/20 rounded-2xl p-4 w-[180px] overflow-hidden group hover:border-[var(--saffron)]/40 transition-all">
                <div className="absolute inset-0 overflow-hidden rounded-2xl opacity-20">
                  <img src="/daretodream.png" alt="Dare to Dream 5.0" className="w-full h-full object-cover" />
                </div>
                <div className="relative z-10">
                  <div className="flex items-center gap-1.5 mb-2">
                    <svg className="w-4 h-4 text-[var(--saffron)]" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                    <span className="text-[var(--saffron)] font-black text-xs">WINNER</span>
                  </div>
                  <p className="text-white font-bold text-sm leading-tight">Dare to Dream</p>
                  <p className="text-white/60 text-xs font-mono mt-0.5">Edition 5.0</p>
                  <p className="text-white/40 text-[10px] mt-2 leading-tight">Validated idea — Startup competition</p>
                </div>
              </div>
            </div>
          </div>
